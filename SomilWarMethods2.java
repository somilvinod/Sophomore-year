...
public class SomilWarMethods2 {
    ...
    public static void main(String[] args) {
        ...
        WarMain(player1Deck, player2Deck, warChest);

        EndGame(player1Deck, player2Deck, r);


    }

    public static void WarMain(ArrayList<Integer> hand1, ArrayList<Integer> hand2, ArrayList<Integer> warChest) {
    ...
    public static void EndGame(ArrayList<Integer> hand1, ArrayList<Integer> hand2, int r) {
